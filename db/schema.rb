...
ActiveRecord::Schema.define(version: 2018_11_02_161953) do
  ...
  create_table "cloud_storage_archives", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["work_id"], name: "index_cloud_storage_archives_on_work_id", unique: true
  end
