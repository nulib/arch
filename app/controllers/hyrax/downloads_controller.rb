module Hyrax
  class DownloadsController < ApplicationController
    ...
    # override: https://github.com/samvera/hydra-head/blob/0b0d2fad9c259b58c9701fb70c9bba44857ce99c/hydra-core/app/controllers/concerns/hydra/controller/controller_behavior.rb#L23
    # hides unauthorized flash message for mixed work visibility images
